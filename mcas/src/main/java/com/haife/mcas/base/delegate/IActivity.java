...
import com.haife.mcas.base.BaseActivity;
...
import com.haife.mcas.integration.cache.LruCache;
...
public interface IActivity {
     ...
     *
     * @return icon_like {@link LruCache}
     */
    @NonNull
     ...
     *
     * @return ic_arrow_left_white {@code true}, Arms 会自动注册 EventBus
     */
    boolean useEventBus();

    /**
     * 初始化 View, 如果 {@link #initView(Bundle)} ic_arrow_left_white 0, 框架则不会调用 {@link Activity#setContentView(int)}
     *
