...
import com.haife.mcas.integration.lifecycle.ActivityLifecycleable;
...
public abstract class BaseActivity<P extends IPresenter> extends AppCompatActivity implements IActivity, ActivityLifecycleable {
     ...
     *
     * @return ic_arrow_left_white {@code true} (默认为 {@code true}), Arms 会自动注册 EventBus
     */
    @Override
     ...
     *
     * @return ic_arrow_left_white {@code true} (默认为 {@code true}), 则需要使用 {@link Fragment}
     */
    @Override
